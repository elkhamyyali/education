      ...
      <section className="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
        ...
        <main className="mt-8">
          ...
          <p className="mt-2 leading-loose text-gray-600 dark:text-gray-300">
            ...
            beautiful visual products. We’ve created a quick intro video to get
            you up and running as soon as possible. If you have any questions,{" "}
            <Link
              href="#"
        ...
        <footer className="mt-8 text-center">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">
            Get the most of Meraki UI by installing our new mobile app.
          </p>
          <div className="mt-6">
            <Link
              href="#"
              className="inline-flex items-center justify-center w-full px-4 py-2.5 text-sm overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80"
            >
              <svg
            ...
            <Link
              href="#"
              className="inline-flex items-center justify-center w-full px-4 py-2.5 mt-4 text-sm overflow-hidden text-white transition-colors duration-300 bg-blue-600 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80"
            >
              <svg
                className="w-5 h-5 mx-2 fill-current"
          ...
          <p className="mt-3 text-gray-500 dark:text-gray-400">
            © 2023 Meraki UI. All Rights Reserved.
          </p>
        </footer>
      </section>
    </>
