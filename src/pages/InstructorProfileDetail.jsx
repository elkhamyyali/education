    ...
    <div className="bg-gray-100">
      <div className="p-8">
        <div className="grid sm:grid-cols-1 grid-cols-12 gap-6 px-1">
          ...
          <div className="sm:col-span-1 col-span-9">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="flex justify-center items-center gap-6 my-6">
                ...
                >
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9 26.2 26.2 58 34.4 93.9 36.2 37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.9 0-184.9zM398.8 388c-7.8 19.7-23.1 35-42.8 42.8-29.6 11.8-99.8 9.1-133.9 9.1s-104.3 2.6-133.9-9.1c-19.7-7.8-35-23.1-42.8-42.8-11.8-29.6-9.1-99.8-9.1-133.9s-2.6-104.3 9.1-133.9c7.8-19.7 23.1-35 42.8-42.8 29.6-11.8 99.8-9.1 133.9-9.1s104.3-2.6 133.9 9.1c19.7 7.8 35 23.1 42.8 42.8 11.8 29.6 9.1 99.8 9.1 133.9s2.7 104.3-9.1 133.9z"
                    ></path>
                  </svg>
                </Link>
              </div>
